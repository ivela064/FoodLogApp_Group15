...
def run():
    st.title("Food Log App - Group 15 SEPM uOttawa Nov-Dec/2022")
    img_file = st.file_uploader("Upload your food image", type=["jpg", "png"])
    if img_file is not None:
        img = Image.open(img_file).resize((250,250))
        st.image(img,use_column_width=False)
        save_image_path = 'C:/Users/gamem/OneDrive/Desktop/ImagesPOC/'+img_file.name
        #C:\Users\gamem\OneDrive\Desktop\ImagesPOC
